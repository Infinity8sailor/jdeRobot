/*    jdeRobot Gsoc 2020  | C++ challenge |
Vaibhav Dasharathe | vinfinitysailor@gmail.com   | https://github.com/Infinity8sailor |   */
...
int main(){
	ifstream file("schema3.txt");	     // reading schema from txt file
	string a;
	vector<string> matrix;
	while(getline(file, a)){ matrix.push_back(a); }
